      ...
      <AlertDialogContent className=" rounded-lg shadow-2xl border border-secondary">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-sm text-gray-500">
            Tem certeza que deseja publicar este conteúdo? Após a publicação,
            ele estará disponível para todos visualizarem.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter className="space-x-2">
          <AlertDialogCancel asChild>
            <Button
              variant="outline"
              className="text-gray-500 border-gray-300 hover:text-gray-700"
            >
              Cancelar
            </Button>
          </AlertDialogCancel>
          ...
          >
            <Button className="text-white bg-red-500 hover:bg-red-600 transition-all duration-200">
