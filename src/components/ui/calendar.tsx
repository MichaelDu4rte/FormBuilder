...
function Calendar({
  ...
  return (
    <div className="bg-[hsl(var(--background))] shadow-lg rounded-lg p-4 border">
      <DayPicker
        ...
        classNames={{
          ...
          month: "space-y-4",
          caption:
            "flex justify-center pt-1 relative items-center text-[hsl(var(--foreground))]",
          ...
          day_selected:
            "bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] focus:bg-[hsl(var(--primary))] focus:text-[hsl(var(--primary-foreground))]",
          day_today:
